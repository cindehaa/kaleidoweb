...
window.PaperShaders={DitheringShapes:ro,DitheringTypes:so,DotGridShapes:Ke,GemSmokeShapes:Po,GlassDistortionShapes:_o,GlassGridShapes:xo,GrainGradientShapes:lo,HalftoneCmykTypes:Mo,HalftoneDotsGrids:Fo,HalftoneDotsTypes:Io,LiquidMetalShapes:Vo,PulsingBorderAspectRatios:uo,ShaderFitOptions:Ne,ShaderMount:pe,WarpPatterns:eo,colorPanelsFragmentShader:fo,colorPanelsMeta:ue,defaultObjectSizing:Ge,defaultPatternSizing:Te,ditheringFragmentShader:io,dotGridFragmentShader:He,dotOrbitFragmentShader:Le,dotOrbitMeta:ge,emptyPixel:Ho,flutedGlassFragmentShader:ho,gemSmokeFragmentShader:Oo,gemSmokeMeta:Be,getShaderColorFromString:Go,getShaderNoiseTexture:Yo,godRaysFragmentShader:oo,godRaysMeta:_e,grainGradientFragmentShader:no,grainGradientMeta:Ae,halftoneCmykFragmentShader:Ro,halftoneDotsFragmentShader:ko,heatmapFragmentShader:bo,heatmapMeta:Se,imageDitheringFragmentShader:yo,isPaperShaderElement:Ee,lensDistortionFragmentShader:Ao,lensDistortionMeta:Fe,liquidMetalFragmentShader:wo,meshGradientFragmentShader:Qe,meshGradientMeta:de,metaballsFragmentShader:je,metaballsMeta:le,neuroNoiseFragmentShader:Ye,paperTextureFragmentShader:go,perlinNoiseFragmentShader:Je,pulsingBorderFragmentShader:co,pulsingBorderMeta:ce,simplexNoiseFragmentShader:Xe,simplexNoiseMeta:ve,smokeRingFragmentShader:We,smokeRingMeta:ne,spiralFragmentShader:to,staticMeshGradientFragmentShader:mo,staticMeshGradientMeta:be,staticRadialGradientFragmentShader:po,staticRadialGradientMeta:Ce,swirlFragmentShader:ao,swirlMeta:ye,toProcessedGemSmoke:zo,toProcessedHeatmap:Co,toProcessedLiquidMetal:So,voronoiFragmentShader:qe,voronoiMeta:he,warpFragmentShader:$e,warpMeta:xe,waterFragmentShader:vo,wavesFragmentShader:Ze};
})();
